...
//         cursor[0].style.cssText = 'left: ' + (e.clientX * 0.6) + 'px; top:' + (e.clientY) + 'px; transform: rotateZ(' + (e.clientX * 2); + 'deg;';
//         cursor[1].style.cssText = 'left: ' + (e.clientX * 1.1) + 'px; top:' + (e.clientY) + 'px; transform: rotateZ(' + (e.clientX * 2); + 'deg;';
//         cursor[2].style.cssText = 'left: ' + (e.clientX * 0.9) + 'px; top:' + (e.clientY) + 'px;';
//     });
// });
...
// transform: rotateZ(' + (e.clientX * 2); + 'deg;'
